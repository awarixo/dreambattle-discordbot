...
class Chain(commands.Cog):
    ...
    @app_commands.describe(fighter = "Describe your fighter")
    async def controlp1(self, interaction: discord.Interaction, *, fighter:str):
        global control_player1
        global p1_username
    ...
    async def controlp2(self, interaction:discord.Interaction , *, fighter:str):
        global control_player1, control_player2, p2_username, chain_result
    ...
    @app_commands.describe(action = "Fighter action")
    async def actionp1(self, interaction:discord.Interaction, *, action:str):
        ...
        #3RD ROUND PLAYER 1 ACTION2
            ...
            print(control_player1,second_action_player1)
    ...
    async def actionp2(self, interaction:discord.Interaction, *, action:str):
        global control_player1, control_player2, chain_counter, action_player1, second_action_player1, action_player2, chain_result
        try:
        ...
        if chain_counter == 0: #Check if this is the first chain or 2nd chain
            ...
            try:
                ...
                chain_result2_check = chain_result2 
                #Check to see if chain battle is completed
                chain_result2_list = chain_result2_check.split('.')
                chain_result2_list = chain_result2_list[-2:]
                ...
                if ("completed" or "1") in chain_check:
                    chain_counter = 0
        ...
        #3RD ROUND PLAYER 2 ACTION2
            ...
            print("FIRST CHAIN P2 REGISTERED")
            await interaction.channel.send("SECOND ACTION REGISTERED.")
            try:
